...
export default function AuthDebugPage() {
    ...
    const payloadExample = useMemo(
        () => (
            {
                "orderName": "갤럭시 z플립5 휴대폰 전면 액정 수리",
                "amount": 235000,
                "customerName": "홍길동",
                "bankCode": "088",
                "customerEmail": "hong1234@gmail.com",
    ...
    return (
        <div className="p-6 max-w-3xl mx-auto space-y-6">
                ...
                <div className="rounded-2xl border p-4 bg-white">
                    ...
                    <div className="text-sm">
                        <div className="flex items-center justify-between">
                            ...
                            <code className="ml-2 break-all whitespace-pre-wrap">
                                {showToken ? (accessToken || '') : mask(accessToken)}
                            </code>
                        </div>
            ...
            {/* user 전체 */}
            <div className="rounded-2xl border p-4 bg-white">
                <h2 className="font-semibold mb-2">로그인 시 받아온 user 객체</h2>
                <pre className="text-xs bg-gray-50 p-3 rounded-lg overflow-auto">
                    {JSON.stringify(user, null, 2)}
                </pre>
            </div>
            <div className="rounded-2xl border p-4 bg-white">
                <h2 className="font-semibold mb-2">각 페이지 작업 시 활용 예시</h2>
                <pre className="text-xs bg-gray-50 p-3 rounded-lg overflow-auto">
                    <p>import &#123; useAuth &#125; from ..../hooks/useAuth;</p><br/>
                    <p>const &#123; user &#125; = useAuth();</p><br/>
                    <p>user.role</p>
                    <p>user.email</p>
                </pre>
            </div>
